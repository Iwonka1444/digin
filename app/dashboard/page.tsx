          ...
          {view === "brandlab" && (
            <div className="p-4 lg:p-8 max-w-4xl mx-auto lg:max-w-none space-y-6">
              ...
              <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
                ...
                <textarea value={rewriteInput} onChange={(e) => setRewriteInput(e.target.value)} placeholder={t.lab_rewrite_ph} rows={5} className="w-full resize-none rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm outline-none focus:border-slate-400 focus:ring-1 focus:ring-slate-300 transition mb-3" />
